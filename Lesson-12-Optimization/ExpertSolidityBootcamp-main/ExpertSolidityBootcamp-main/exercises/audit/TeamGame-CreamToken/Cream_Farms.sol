...
contract CreamFarms is Ownable {
    ...
    constructor(IERC20 _CREAM, uint256 _creamPerBlock, uint256 _startBlock, uint256 _endBlock) public {
        CREAM = _CREAM;
     ...
     */
    function setCreamPerBlock(uint256 _creamPerBlock) external onlyOwner returns (uint256) {
